    ...
    return (
      <Layout {...this.props} navmenu={false} container={false}>
        ...
        >
          <Container className="mt-2 mb-2">
            ...
            <p className="text-right">
              ...
              >
                <span className="icon ion-logo-github mr-2" /> Download from
                GitHub
              </a>
            </p>
            <style jsx>{`
        ...
        <Container>
            ...
            <Col xs="12" sm="4" className="pt-5">
              ...
              <ListGroup>
                ...
                <ListGroupItem>
                  <a
                    className="text-dark"
                    href="https://www.npmjs.com/package/express-sessions"
                  >
                    Express Sessions
                  </a>
                </ListGroupItem>
                ...
                <ListGroupItem>
                  <a
                    className="text-dark"
                    href="https://www.owasp.org/index.php/HttpOnly"
                  >
                    HTTP Only Cookies
                  </a>
                </ListGroupItem>
            ...
            <Col xs="12" sm="4" className="pt-5">
              ...
              <ListGroup>
                ...
                <ListGroupItem>
                  <a
                    className="text-dark"
                    href="https://ionicframework.com/docs/ionicons/"
                  >
                    Ionicons
                  </a>
                </ListGroupItem>
          ...
          <p>
            This project integrates several concepts to show how you can use
            them together in a Next.js project.
          </p>
...
npm run dev`}
          ...
          <p>
            The simplest way to deploy projects to the cloud is with with 'now',
            which is from Zeit, the creators of Next.js framework.
          </p>
          <pre>
            {`npm install -g now
now`}
